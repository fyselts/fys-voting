      ...
      <section className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button
            ...
            className="px-6 py-3 rounded-lg font-bold text-white bg-[var(--color-primary)] hover:bg-[color:rgba(0,8,125,0.85)] transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isExporting ? (
              <>
